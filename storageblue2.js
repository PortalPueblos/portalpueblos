...
// cambiado
	var trtd = '<div class="contentdiv"><a href="'+posturl+'"><img width="407" height="240" class="alignnone" src="'+img[i]+'"/></a><div class="sliderPostInfo"><h2 class="featuredTitle" style="padding:0 10px;">-<a href="'+posturl+'">'+posttitle+'</a></h2></div></div>'; 
