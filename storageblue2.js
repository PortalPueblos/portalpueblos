...
// cambiado
	var trtd = '<div class="contentdiv"><a href="'+posturl+'"><img width="407" height="240" class="alignnone" src="'+img[i]+'"/></a><div class="sliderPostInfo"><h3><a href="'+posturl+'">'+posttitle+'</a></h3></div></div>'; 
